words = ['List', 'Tupple', 'nested loop','dictionary', 'string method', 'set', 'keyword','assert', 'class:', 'elif:','Compiler', 'global variable', 'Array', 'Linkedin', 'Linked List', 'Data Structure' 'debugging', 'while loop']
...
def time():
    ...
    if (timeleft > 0):
        ...
        rr = messagebox.askretrycancel('Notification', 'for play again hit button')
        if (rr == True):
            score = 0
            timeleft = 14
            miss = 0
...
scoreLable = Label(root, text='Your Score: ', font=('aircal', 25, 'italic bold'), bg='powder blue', fg='blue')
scoreLable.place(x=10, y=100)
scoreLableCount = Label(root, text='0', font=('airal', 25, 'italic bold'), bg='powder blue', fg='blue')
